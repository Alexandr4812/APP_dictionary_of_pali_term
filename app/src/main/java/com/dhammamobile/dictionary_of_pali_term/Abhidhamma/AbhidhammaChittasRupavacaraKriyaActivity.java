...
public class AbhidhammaChittasRupavacaraKriyaActivity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewAbhidhammaRupavacaraKusala3 = findViewById(R.id.textView_abhidhamma_chittas_rupavacara_kriya3);
        textViewAbhidhammaRupavacaraKusala4 = findViewById(R.id.textView_abhidhamma_chittas_rupavacara_kriya4);
        textViewAbhidhammaRupavacaraKusala5 = findViewById(R.id.textView_abhidhamma_chittas_rupavacara_kriya5);
        textViewAbhidhammaRupavacaraKusala6 = findViewById(R.id.textView_abhidhamma_chittas_rupavacara_kriya6);

        rupavacaraKusala1 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya1);
        rupavacaraKusala2 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya2);
        rupavacaraKusala3 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya3);
        rupavacaraKusala4 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya4);
        rupavacaraKusala5 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya5);
        rupavacaraKusala6 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya6);

        koren1 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_koren1);
        koren2 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_koren2);
        koren3 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_koren3);
        koren4 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_koren4);
        koren5 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_koren5);

        funkciya1 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_funkciya1);
        funkciya2 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_funkciya2);
        funkciya3 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_funkciya3);
        funkciya4 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_funkciya4);
        funkciya5 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_funkciya5);


        kombinaciya1 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_kombinaciya1);
        kombinaciya2 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_kombinaciya2);
        kombinaciya3 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_kombinaciya3);
        kombinaciya4 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_kombinaciya4);
        kombinaciya5 = findViewById(R.id.button_abhidhamma_chittas_rupavacara_kriya_kombinaciya5);
    }

    public void onButtonClickAbhidhammaRupavacaraKriyaGroup1(View view) {
    ...
    public void onButtonClickAbhidhammaRupavacaraKriyaGroup2(View view) {
        Button clickedButton = (Button) view;
    ...
    public void onButtonClickAbhidhammaRupavacaraKriyaGroup3(View view) {
        Button clickedButton = (Button) view;
    ...
    public void onButtonClickAbhidhammaRupavacaraKriyaGroup4(View view) {
        Button clickedButton = (Button) view;
    ...
    public void onButtonClickAbhidhammaRupavacaraKriyaGroup5(View view) {
        Button clickedButton = (Button) view;
    ...
    public void onButtonClickAbhidhammaRupavacaraKriyaGroup6(View view) {
        Button clickedButton = (Button) view;
    ...
    public void toAbhidhammaChittasKriya(View view){
