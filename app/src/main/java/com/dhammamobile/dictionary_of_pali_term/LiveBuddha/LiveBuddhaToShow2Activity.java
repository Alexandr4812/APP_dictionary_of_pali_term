...
public class LiveBuddhaToShow2Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_buddha_to_show_2);
        ...
        webView = findViewById(R.id.webViewLive2);
