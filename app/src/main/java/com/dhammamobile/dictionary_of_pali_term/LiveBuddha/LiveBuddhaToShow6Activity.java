...
public class LiveBuddhaToShow6Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_buddha_to_show6);
        ...
        webView = findViewById(R.id.webViewLive6);
