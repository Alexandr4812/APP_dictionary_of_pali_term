...
public class LiveBuddhaToShow9Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_buddha_to_show9);
        ...
        webView = findViewById(R.id.webViewLive9);
