...
public class TeacherLec212Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_lec212);
        ...
        webView = findViewById(R.id.webViewLec212);
    ...
    public void toSatrtTeacherLec212Act() {
        String htmlFilePath;
        String currentLanguage = Locale.getDefault().getLanguage();
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/lec_ru/kamaRu.html";
        } else {
            htmlFilePath = "file:///android_asset/lec_ru/kamaRu.html";
        }
