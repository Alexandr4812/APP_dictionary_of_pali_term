...
public class TeacherLec3Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_lec3);
        ...
        WebView webView = findViewById(R.id.webViewLec3);
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/lec_ru/lec3.html";
        } else {
            htmlFilePath = "file:///android_asset/lec_ru/lecEn3.html";
        }
