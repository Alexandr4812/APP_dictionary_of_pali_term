...
public class TeacherLec7Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_lec7);

        // Скрытие панели навигации и панели состояния
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        plusText = findViewById(R.id.buttonPlusTextTeacher7);
        minusText = findViewById(R.id.buttonMinusTextTeacher7);

        WebView webView = findViewById(R.id.webViewLec7);
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/lec_ru/lec7.html";
        } else {
            htmlFilePath = "file:///android_asset/lec_ru/lecEn7.html";
        }
