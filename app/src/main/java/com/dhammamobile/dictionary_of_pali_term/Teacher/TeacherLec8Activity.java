...
public class TeacherLec8Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_lec8);

        // Скрытие панели навигации и панели состояния
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        plusText = findViewById(R.id.buttonPlusTextTeacher8);
        minusText = findViewById(R.id.buttonMinusTextTeacher8);

        WebView webView = findViewById(R.id.webViewLec8);
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/lec_ru/lec8.html";
        } else {
            htmlFilePath = "file:///android_asset/lec_ru/lecEn8.html";
        }
