...
public class RulesBhikkhuPatimokhaSanghadisesaDetail3Activity extends BaseActivityClass {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rules_bhikkhu_patimokha_sanghadisesa_detail3);

        // Скрытие панели навигации и панели состояния
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        webView = findViewById(R.id.webViewSanghadisesaDetail3);
