...
public class RulesBhikkhuPatimokhaSanghadisesaDetail1Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/par_detail_ru/sd1.html";
        } else {
            htmlFilePath = "file:///android_asset/par_detail_en/sd1.html";
        }
