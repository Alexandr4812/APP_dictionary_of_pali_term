...
public class RulesBhikkhuPatimokhaParajikaDetail2Activity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/par_detail_ru/pr2.html";
        } else {
            htmlFilePath = "file:///android_asset/par_detail_en/pr2.rf.html";
        }
