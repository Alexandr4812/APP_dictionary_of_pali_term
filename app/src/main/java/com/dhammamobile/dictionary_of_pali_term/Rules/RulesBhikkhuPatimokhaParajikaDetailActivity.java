...
public class RulesBhikkhuPatimokhaParajikaDetailActivity extends BaseActivityClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rules_bhikkhu_patimokha_parajika_detail);

        // Скрытие панели навигации и панели состояния
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);

        webView = findViewById(R.id.webViewParajikaDetail);
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/par_detail_ru/pr1.html";
        } else {
            htmlFilePath = "file:///android_asset/par_detail_en/pr1.html";
        }
