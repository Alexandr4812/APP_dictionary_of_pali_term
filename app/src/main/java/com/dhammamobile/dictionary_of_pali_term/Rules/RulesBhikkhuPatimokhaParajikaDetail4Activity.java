...
public class RulesBhikkhuPatimokhaParajikaDetail4Activity extends BaseActivityClass {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rules_bhikkhu_patimokha_parajika_detail4);
        ...
        webView = findViewById(R.id.webViewParajikaDetail4);
        ...
        if (currentLanguage.equals("ru")) {
            htmlFilePath = "file:///android_asset/par_detail_ru/pr4.html";
        } else {
            htmlFilePath = "file:///android_asset/par_detail_en/pr4.html";
        }
